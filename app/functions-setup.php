 ...
 */
 add_action( 'after_setup_theme', function() {
	...
	hybrid_require_if_theme_supports( 'breadcrumb-trail', app()->dir . 'ext/breadcrumb-trail.php' );
	hybrid_require_if_theme_supports( 'cleaner-gallery',  app()->dir . 'ext/cleaner-gallery.php'  );
	hybrid_require_if_theme_supports( 'get-the-image',    app()->dir . 'ext/get-the-image.php'    );
